//
//  PostcastTableViewController.swift
//  TraningExe10.1
//
...
import UIKit
import Alamofire
class PostcastTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("okok")
        Alamofire.request("https://itunes.apple.com/search?term=jack+johnson&entity=podcast").responseJSON { (response) in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "podcastCell", for: indexPath) as! PostcastTableViewCell
        if listSong.count != 0{
